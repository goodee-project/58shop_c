...
public interface GoodsMapper {
	public Map<String, Object> selectGoodsOneCompany(Map<String, Object> goodsOne);
	public List<Map<String, Object>> selectGoodsCompany(Map<String, Object> company); // 특정업체 상품만 보기(업체스토어)
