...
<header class="header menu_fixed">
		...
		<nav id="menu" class="main-menu">
			<ul>
				...
				<li>
					<span><a href="${pageContext.request.contextPath}/goods/category?typeNo=1">Beauty</a></span>
					<ul>
						<li>
				...
				<li>
					<span><a href="${pageContext.request.contextPath}/goods/category?typeNo=8">Fashion</a></span>
					<ul>
						<li>
				...
				<li>
					<span><a href="${pageContext.request.contextPath}/goods/category?typeNo=17">Market</a></span>
					<ul>
